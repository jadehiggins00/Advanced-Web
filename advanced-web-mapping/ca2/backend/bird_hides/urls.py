...
from .views import fetch_bird_hides_in_ireland, get_all_locations, AddBirdLocation, UpdateBirdLocation, DeleteBirdLocation,logout_view, login_view, session_view,whoami_view, register_view
